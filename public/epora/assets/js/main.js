...
(function ($) {
    ...
    function initializeSlider(className, appendArrows, autoplay = false) {
        $(className).slick({
            infinite: true,
            slidesToShow: 3,
            slidesToScroll: 1,
            ...
            nextArrow:
                '<button type="button" class="slick-next"><i class="arrow_carrot-right"></i></button>',
            arrows: appendArrows ? true : false,
    ...
    initializeSlider(".intruc-active", $(".tp-instruc-arrow"));
    // Inisialisasi slider kedua
    initializeSlider(".intruc-active-two", $(".tp-instruc-arrow"), true);
    // Inisialisasi slider ketiga
    initializeSlider(".course-active", $(".tp-course-arrow"));
    // Inisialisasi slider keempat
    initializeSlider(".intruc-course-two", $(".tp-course-arrow"), true);
