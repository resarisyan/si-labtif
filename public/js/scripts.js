    ...
    NioApp.Custom.Stepper = function (elm, opt) {
        ...
        let nav_items = elm.querySelectorAll(`.${settings.selectors.nav} > *`),
            step_items = elm.querySelectorAll(
                `.${settings.selectors.content} > *`
            ),
            step_progress = elm.querySelector(
                `.${settings.selectors.progress}`
            ),
            step_progress_count = elm.querySelector(
                `.${settings.selectors.progress}-count`
            ),
            step_progress_bar = elm.querySelector(
                `.${settings.selectors.progress}-bar`
            ),
            ...
            _step_nav =
                elm.querySelectorAll(`.${settings.selectors.nav}`).length > 0
                    ? true
                    : false,
            _step_progress =
                elm.querySelectorAll(`.${settings.selectors.progress}`).length >
                0
                    ? true
                    : false;
        //Show step function
